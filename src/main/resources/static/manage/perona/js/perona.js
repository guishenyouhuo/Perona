    	...
    	table: {
			...
			tooltip: function (value, length, target) {
				...
				if (_value.length > _length) {
                	...
                	actions.push($.common.sprintf('<span class="tooltip-show" data-toggle="tooltip" data-target="%s" title="%s">%s</span>', _target, _value, _text));
					return actions.join('');
				} else {
					_text = _value;
					return _text;
        ...
        operate: {
            ...
            successTabCallback: function(result) {
                if (result.code == web_status.SUCCESS) {
    	            ...
    	            var $contentWindow = $('.Perona_iframe[data-id="' + currentId + '"]', topWindow)[0].contentWindow;
    	            $.modal.close();
