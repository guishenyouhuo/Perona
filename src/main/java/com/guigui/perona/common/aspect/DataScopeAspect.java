...
public class DataScopeAspect {
    ...
    // 配置织入点
    @Pointcut("@annotation(com.guigui.perona.common.aspect.annotation.DataScope)")
     ...
     */
    public static void dataScopeFilter(JoinPoint joinPoint, UserInfo userInfo, String deptAlias, String userAlias) {
        ...
        for (RoleInfo role : userInfo.getRoleList()) {
            ...
            if (DATA_SCOPE_ALL.equals(dataScope)) {
                ...
                sqlString.append(StringUtils.format(" OR {}.dept_id = {} ", deptAlias, userInfo.getDeptId()));
            } else if (DATA_SCOPE_DEPT_AND_CHILD.equals(dataScope)) {
                sqlString.append(StringUtils.format(
                        " OR {}.dept_id IN ( SELECT dept_id FROM dept_info WHERE dept_id = {} or find_in_set( {} , ancestors ) )",
                        deptAlias, userInfo.getDeptId(), userInfo.getDeptId()));
            } else if (DATA_SCOPE_SELF.equals(dataScope)) {
                if (StringUtils.isNotBlank(userAlias)) {
                    sqlString.append(StringUtils.format(" OR {}.id = {} ", userAlias, userInfo.getId()));
                } else {
