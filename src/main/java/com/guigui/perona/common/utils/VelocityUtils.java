...
public class VelocityUtils {
     ...
     * mybatis空间路径
     */
    private static final String MYBATIS_PATH = "main/resources/mapper/perona";
...
//        templates.add("vm/sql/sql.vm");
    ...
    public static String getTreeCode(JSONObject paramsObj) {
        if (paramsObj.containsKey(GenConstants.TREE_CODE)) {
            return StringUtils.underScore2CamelCase(paramsObj.getString(GenConstants.TREE_CODE), false);
        }
        return "";
    }
    ...
    public static String getTreeParentCode(JSONObject paramsObj) {
        if (paramsObj.containsKey(GenConstants.TREE_PARENT_CODE)) {
            return StringUtils.underScore2CamelCase(paramsObj.getString(GenConstants.TREE_PARENT_CODE), false);
        }
        return "";
    }
    ...
    public static String getTreeName(JSONObject paramsObj) {
        if (paramsObj.containsKey(GenConstants.TREE_NAME)) {
            return StringUtils.underScore2CamelCase(paramsObj.getString(GenConstants.TREE_NAME), false);
        }
        return "";
    }
