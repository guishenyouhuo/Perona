...
public class GenTableColumn extends BaseEntity {
    ...
    private static final long serialVersionUID = 6445824121315582832L;
    ...
    // superColumn()中的名单用于避免生成多余Domain属性，若某些属性在生成页面时需要用到不能忽略，则放在此处白名单
    public static boolean isUsableColumn(String javaField) {
        return StringUtils.equalsAnyIgnoreCase(javaField, GenConstants.USABLE_FIELD);
    }

    // 用于生成Excel处理 TODO 待修改
