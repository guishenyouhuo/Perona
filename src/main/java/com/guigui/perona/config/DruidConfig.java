...
import com.guigui.perona.config.properties.DruidProperties;
import com.guigui.perona.datasource.DynamicDataSource;
...
public class DruidConfig {
    ...
    public DynamicDataSource dataSource(DataSource masterDataSource) {
        ...
        if (Boolean.TRUE.toString().equals(slaveEnable)) {
